...
define( 'EWWW_IMAGE_OPTIMIZER_VERSION', '617.1' );
...
function ewww_image_optimizer_init() {
	...
	if ( defined( 'DOING_WPLR_REQUEST' ) && DOING_WPLR_REQUEST && ! defined( 'EWWWIO_WPLR_AUTO' ) ) {
		...
		add_filter( 'wplr_add_media', 'ewww_image_optimizer_lr_sync_update' );
		add_filter( 'wplr_update_media', 'ewww_image_optimizer_lr_sync_update' );
