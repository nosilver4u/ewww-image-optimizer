...
define( 'EWWW_IMAGE_OPTIMIZER_VERSION', '603.003' );
...
// Run things that need to follow admin_init like the relative migration tool.
add_action( 'wp', 'ewww_image_optimizer_late_init' );
